...
If it doesn't do risk management or position sizing, say so explicitly — traders will otherwise assume it's a complete decision system rather than an input to one.
